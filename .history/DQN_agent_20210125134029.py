...
class DQN:
    ...
    def build_modelGPU(self, input_shape=(4, 100, 100,), action_space=6, dueling=True):
        ...
        X = Conv2D(128, 4, strides=(2),padding="s",kernel_initializer=truncatedn_init, bias_initializer=const_init,  use_bias=True,activation="relu", data_format="channels_first")(X)
        X = Flatten()(X)
