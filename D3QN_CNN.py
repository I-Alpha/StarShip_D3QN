...
def OurModel(input_shape, action_space, dueling):
    ...
    X = Conv2D(64, 5, strides=(35, 35),padding="valid", input_shape=input_shape, activation="relu", data_format="channels_first")(X)
    X = Conv2D(64, 4, strides=(2, 2),padding="valid", activation="relu", data_format="channels_first")(X)
    X = Conv2D(64, 2, strides=(1, 1),padding="valid", activation="relu", data_format="channels_first")(X)
    X = Flatten()(X)
    ...
    model = Model(inputs = X_input, outputs = X, name='DQ3model')
...
class DQNAgent:
    def __init__(self, env_name):
        ...
        self.env = StarShipGame(True) 
        # by default, CartPole-v1 has max episode steps = 500
        # we can use this to experiment beyond 500
        self.env._max_episode_steps = 30000
        self.state_size = 80000
        self.action_size = 6
        self.EPISODES = 1000
        # Instantiate memory
        memory_size = 1000
    ...
    def imshow(self, image, rem_step=0):
        cv2.imshow("SpaceShip"+str(rem_step), image[rem_step,...])
    ...
    def GetImage(self):
        ...
        # img_rgb_resized = cv2.resize(img_rgb, (300, 400), interpolation=cv2.INTER_CUBIC)
        ...
        return  self.env.getPixelsOnScreenNew()
        ...
        for e in range(self.EPISODES):
            ...
            while not done:
                ...
                if done:
                    ...
                    print("episode: {}/{}, e: {:.2}, average: {}, reward: {}".format(e, self.EPISODES,  explore_probability, average,reward))
                    if i == self.env._max_episode_steps or self.env.save:
    ...
    def test(self):
        ...
        for e in range(self.EPISODES):
            ...
            while not done:
                ...
                i += 1
                if done:
                    print("episode: {}/{}, reward: {}".format(e, self.EPISODES, reward))
                    break

if __name__ == "__main__":
    env_name = 'SpaceShip-v1'
